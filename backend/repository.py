...
def get_all_challenges_with_stats(current_user_id):
    """
    ...
    for challenge in challenges:
        ...
        for p in participants:
            ...
            if p.user_id == current_user_id:
                user_joined = True
                user_completed = p.is_completed
        
        creator = db.session.get(User, challenge.creator_id)
        if creator:
            challenge_dict['creator_name'] = creator.username
        else:
            challenge_dict['creator_name'] = 'Unknown'
        
        challenge_dict['participant_count'] = participant_count
        challenge_dict['completed_count'] = completed_count
        challenge_dict['user_joined'] = user_joined
        challenge_dict['user_completed'] = user_completed
...
def create_challenge(creator_id, title, description, emoji):
    """
