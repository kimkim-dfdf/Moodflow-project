...
class CommunityChallenge(db.Model):
    """
    CommunityChallenge table for storing user-created challenges.
    Users can create challenges and others can join.
    """
...
class ChallengeParticipant(db.Model):
    """
    ChallengeParticipant table for tracking who joined and completed challenges.
    """
